...
const Footer = () => {
	return (
		<footer className="max-container">
			<div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
				...
				<div className=" flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
					{footerLinks.map((section) => (
						<div key={section}>
							<h4 className="text-white font-montserrat text-2xl underline leading-normal font-medium mb-6">
								{" "}
								{section.title}{" "}
							</h4>
            ...
            <div className=" flex justify-between text-white-400 mt-20 max-sm:flex-col items-center">
